# Reader-App
Creating Reader App (with sign in - sign up page), Programmatically without Storyboard Using Swift 5.0+

Reader sample app is written in Swift 5.0+. It can be built by Xcode 11.0 or later. Compatible with iOS 13.0+.
...
In order to compile Reader App you will need to meet the following requirements:
